...
var (
	...
	DataType      = "mysql"
	DBConnect     = "root:rootpass@tcp(127.0.0.1:3306)/db?charset=utf8"
	DBTablePrefix = "dp"
)
...
func createTables(Engine *xorm.Engine) error {
	return Engine.Sync2(&Batch{}, &BlockContent{}, &BlockContent_body{}, &BlockContentFieldData{}, &BlockContentFieldRevision{}, &BlockContentRevision{}, &BlockContentRevision_body{}, &CacheBootstrap{}, &CacheConfig{}, &CacheContainer{}, &CacheData{}, &CacheDefault{}, &CacheDiscovery{}, &CacheDynamicPageCache{}, &CacheEntity{}, &CacheMenu{}, &CacheRender{}, &Cachetags{}, &Comment{}, &Comment_commentBody{}, &CommentEntityStatistics{}, &CommentFieldData{}, &Config{}, &FileManaged{}, &FileUsage{}, &Flood{}, &History{}, &KeyValue{}, &KeyValueExpire{}, &MenuLinkContent{}, &MenuLinkContentData{}, &MenuTree{}, &Node{}, &Node_body{}, &Node_comment{}, &Node_fieldImage{}, &Node_fieldTags{}, &NodeAccess{}, &NodeFieldData{}, &NodeFieldRevision{}, &NodeRevision{}, &NodeRevision_body{}, &NodeRevision_comment{}, &NodeRevision_fieldImage{}, &NodeRevision_fieldTags{}, &Queue{}, &Router{}, &SearchDataset{}, &SearchIndex{}, &SearchTotal{}, &Semaphore{}, &Sequences{}, &Sessions{}, &Shortcut{}, &ShortcutFieldData{}, &ShortcutSetUsers{}, &TaxonomyIndex{}, &TaxonomyTermData{}, &TaxonomyTermFieldData{}, &TaxonomyTermHierarchy{}, &UrlAlias{}, &User_roles{}, &User_userPicture{}, &Users{}, &UsersData{}, &UsersFieldData{}, &Watchdog{})
}
